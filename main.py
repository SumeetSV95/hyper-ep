...
model_choise = 'nn'
ev = 'test'
dirpath = '/home/sv6234/ECGI/checkHybrid_sur_out_weighted'
...
def main():
    ...
    dataset=TMPDataset("/home/sv6234/ECGI/data/TMP_data_UV_new/","/home/sv6234/ECGI/data/TMP_data_GT_new/",15,H=H)
    ...
    train_loader = torch.load('/home/sv6234/ECGI/train_loader_checkHybrid_TMP_full.pt')
    #train_loader = torch.load('/home/sv6234/ECGI/train_loader_checkHybrid_EGM_in.pt')
    #test_loader=DataLoader(test_set,batch_size=batch_size,shuffle=False)
    valid_loader = torch.load('/home/sv6234/ECGI/valid_loader_checkHybrid_TMP_full.pt')
    ...
    if model_choise=='nn':
        model = HybridModel(S, dimD, par, batch_size, ids,isPhysics=False,isRecon=False, surfaceTMP=True,outputSurface=True,adjoint=True,EGM_in=False,EGM_out=False,dilate_loss=False,use_resnet=True,seed=None)
...
# Normalize the parameters
    ...
    logger = TensorBoardLogger('lightning_logs', name='sur_out_weighted')         
    trainer = Trainer(logger=logger,default_root_dir='',limit_train_batches=int(1056/batch_size),limit_val_batches=15,max_epochs=20,accelerator='gpu', devices=1,callbacks=[checkpoint_callback],
